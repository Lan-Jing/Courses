...
.set_dataSeg:
    xor ax, ax 
    mov ds, ax
    mov es, ax      ; set all basic seg pointer to 0, offset added by org
.set_stackSeg:
    cli 
...
.handle_input:
    ...
    jge start       ; get back to the beginning 
...
read_floppy:
    ...
    mov cl, bl      ; get sector index from reg bx, assuming program included in one sector
...
data:
    ...
    message     db  "A basic loader", 0xD, 0xA 
                ...
                db  "    stoneUL.com  1", 0xD, 0xA, "    stoneUR.com  2", 0xD, 0xA, 
